package elevatorSystem.elevatorSubsystem3;
...
import elevatorSystem.elevatorSubsystem3.communication.SchedulerListener;
...
public class ElevatorSubsystem {
	 ...
	 */
	private static final int ListenPort = Port.E_SCHEDULER_LISTENER3.getPort(); 
	
	/**
	 * Port for this elevator subsystem to send to scheduler
	 */
	private static final int SendPort = Port.S_ELEVATOR_LISTENER3.getPort(); 
	...
	public static void main(String[] args) {
		System.out.println("***ELEVATOR 3 SUBSYSTEM***\n\n");
