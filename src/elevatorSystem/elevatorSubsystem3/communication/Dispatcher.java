...
import elevatorSystem.elevatorSubsystem3.states.DestinationSelected;
import elevatorSystem.elevatorSubsystem3.states.StartElevator;
import elevatorSystem.elevatorSubsystem3.states.StopElevator;
...
public class Dispatcher extends Thread {
	...
	public void run() {
		...
		if (Arrays.equals(temp, START_ELEVATOR_HEADER)) {
			System.out.println("Elevator 3: Dispatched to Start Elevator Process ");
			...
			System.out.println("Elevator 3: Dispatched to Stop Elevator Process ");
