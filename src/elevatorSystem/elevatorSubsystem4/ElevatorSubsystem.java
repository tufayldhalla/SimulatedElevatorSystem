package elevatorSystem.elevatorSubsystem4;
...
import elevatorSystem.elevatorSubsystem4.communication.SchedulerListener;
...
public class ElevatorSubsystem {
	 ...
	 */
	private static final int ListenPort = Port.E_SCHEDULER_LISTENER4.getPort();

	/**
	 * Port for this elevator subsystem to receive from scheduler
	 */
	private static final int SendPort = Port.S_ELEVATOR_LISTENER4.getPort();
	...
	public static void main(String[] args) {
		System.out.println("***ELEVATOR 4 SUBSYSTEM***\n\n");
