package elevatorSystem.elevatorSubsystem4.communication;

import java.util.Arrays;

import elevatorSystem.elevatorSubsystem4.ElevatorSubsystem;
import elevatorSystem.elevatorSubsystem4.states.DestinationSelected;
import elevatorSystem.elevatorSubsystem4.states.StartElevator;
import elevatorSystem.elevatorSubsystem4.states.StopElevator;
...
public class Dispatcher extends Thread {
	...
	public void run() {
		...
		if (Arrays.equals(temp, START_ELEVATOR_HEADER)) {
			System.out.println("Elevator 4: Dispatched to Start Elevator Process ");
			...
			System.out.println("Elevator 4: Dispatched to Stop Elevator Process ");
