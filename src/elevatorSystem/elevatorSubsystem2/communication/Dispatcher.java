package elevatorSystem.elevatorSubsystem2.communication;

import java.util.Arrays;

import elevatorSystem.elevatorSubsystem2.ElevatorSubsystem;
import elevatorSystem.elevatorSubsystem2.states.DestinationSelected;
import elevatorSystem.elevatorSubsystem2.states.StartElevator;
import elevatorSystem.elevatorSubsystem2.states.StopElevator;
...
public class Dispatcher extends Thread {
	...
	public void run() {
		...
		if (Arrays.equals(temp, START_ELEVATOR_HEADER)) {
			System.out.println("Elevator 2: Dispatched to Start Elevator Process ");
			...
			System.out.println("Elevator 2: Dispatched to Stop Elevator Process ");
