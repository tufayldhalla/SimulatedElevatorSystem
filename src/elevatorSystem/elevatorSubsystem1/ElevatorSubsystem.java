package elevatorSystem.elevatorSubsystem1;
...
import elevatorSystem.elevatorSubsystem1.communication.SchedulerListener;
...
public class ElevatorSubsystem {
	 ...
	 */
	private static final int ListenPort = Port.E_SCHEDULER_LISTENER1.getPort();

	/**
	 * Port for this elevator subsystem to send to scheduler
	 */
	private static final int SendPort = Port.S_ELEVATOR_LISTENER1.getPort();
	...
	public static void main(String[] args) {
		System.out.println("***ELEVATOR 1 SUBSYSTEM***\n\n");
